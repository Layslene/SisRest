...
public class ExibirItemPedidoDTO {
	...
	public ExibirItemPedidoDTO (ItemPedido obj) {
		this.id = obj.getId();
	...
	public ExibirItemPedidoDTO(Long id, int quantidade, Long clienteId, Long cardapioId) {
		this.id = id;
